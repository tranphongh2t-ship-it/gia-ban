-- =====================================================
-- Schema D1 cho Hệ thống Giá Bán Mới
-- 12 bảng: 10 nghiệp vụ + audit_log + nhan_vien
-- =====================================================

-- 1. Nhân viên (mục 11 SPEC)
...
-- 5. ThanhThuy-GG (giá giấy/phim, 35 cột)
...
-- 6. ThanhThuy-GVT (giá ván trơn, 22 cột)
...
-- 7. Phân bổ KH (gán OP1/OP2 theo tháng — dạng long)
...
-- 8. Bảng giá chiết khấu (từ CHIẾT KHẤU, normalized)
...
-- 9b. Giá bán theo tier (chuẩn hoá từ 63 cột ngang)
...
-- 11. Bán — HUB TRUNG TÂM (56 cột từ BÁN)
