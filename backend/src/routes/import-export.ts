...
const DB_TABLES: TableMeta[] = [
  ...
  { table: 'bang_gia_chi', label: 'Chỉ', group: '8 nhóm nhỏ',
    ...
    keyFields: ['id'] },
  { table: 'bang_gia_keo_nong', label: 'Keo nóng', group: '8 nhóm nhỏ',
  ...
  { table: 'bang_gia_van_phu_pvc', label: 'Ván phủ PVC', group: '8 nhóm nhỏ',
    ...
    keyFields: ['id'] },
  { table: 'bang_gia_nhua_phu_mau', label: 'Nhựa phủ màu', group: '8 nhóm nhỏ',
    ...
    keyFields: ['id'] },
  { table: 'bang_gia_nhua_laminate', label: 'Nhựa Laminate', group: '8 nhóm nhỏ',
  ...
  { table: 'bang_gia_osb_laminate', label: 'OSB Laminate', group: '8 nhóm nhỏ',
    ...
    allColumns: ['id', 'loai_cot', 'tier', 'do_day', 'do_day_thanh_pham', 'le1_backer', 'le2_backer', 'lp1_backer', 'lp2_backer', 'lp3_backer', 'le1_2mat', 'le2_2mat', 'lp1_2mat', 'lp2_2mat', 'lp3_2mat', 'created_at', 'updated_at', 'updated_by'],
    keyFields: ['id'] },
  { table: 'bang_gia_mirror', label: 'Mirror / Siêu bóng gương', group: '8 nhóm nhỏ',
    columns: ['loai', 'tier', 'ten', 'loai_cot', 'gia', 'ghi_chu'],
    allColumns: ['id', 'loai', 'tier', 'ten', 'loai_cot', 'gia', 'ghi_chu', 'created_at', 'updated_at', 'updated_by'],
    keyFields: ['id'] },
