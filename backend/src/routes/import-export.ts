...
const DB_TABLES: TableMeta[] = [
  ...
  { table: 'so_chi_tiet_ban_hang', label: 'Sổ chi tiết bán hàng', group: 'Dữ liệu',
    ...
    keyFields: ['id'] },
  { table: 'check_gia_goc_ck', label: 'Audit Giá Gốc', group: 'Dữ liệu',
    columns: ['ngay', 'so_ct', 'dien_giai', 'ma_kh', 'ten_kh', 'ma_hang', 'ten_hang', 'sl_ban', 'don_gia', 'doanh_so', 'ck', 'sl_tra', 'gt_tra', 'gt_giam', 'thue'],
    allColumns: ['id', 'ngay', 'so_ct', 'dien_giai', 'ma_kh', 'ten_kh', 'ma_hang', 'ten_hang', 'sl_ban', 'don_gia', 'doanh_so', 'ck', 'sl_tra', 'gt_tra', 'gt_giam', 'thue', 'created_at', 'owner_user_id'],
    exportColumns: ['ngay', 'so_ct', 'dien_giai', 'ma_kh', 'ten_kh', 'ma_hang', 'ten_hang', 'sl_ban', 'don_gia', 'gia_goc', 'gia_goc_ngay', 'gia_misa', 'chech_lech', 'doanh_so', 'ck', 'sl_tra', 'gt_tra', 'gt_giam', 'thue', 'id', 'created_at', 'owner_user_id'],
    exportAllColumns: ['id', 'ngay', 'so_ct', 'dien_giai', 'ma_kh', 'ten_kh', 'ma_hang', 'ten_hang', 'sl_ban', 'don_gia', 'gia_goc', 'gia_goc_ngay', 'gia_misa', 'chech_lech', 'doanh_so', 'ck', 'sl_tra', 'gt_tra', 'gt_giam', 'thue', 'created_at', 'owner_user_id'],
    ...
    keyFields: ['id'] },
  { table: 'check_chiet_khau_test', label: 'Audit Chiết Khấu', group: 'Dữ liệu',
    ...
    allColumns: ['id', 'ngay', 'so_ct', 'dien_giai', 'ma_kh', 'ten_kh', 'ma_hang', 'ten_hang', 'sl_ban', 'don_gia', 'doanh_so', 'ck', 'sl_tra', 'gt_tra', 'gt_giam', 'thue', 'ck1_pct', 'ck2_pct', 'ck3_pct', 'tong_pct', 'ck_tinh', 'nhom_mau', 'dieu_kien', 'giai_thich', 'sua_ck1_pct', 'sua_ck2_pct', 'sua_ck3_pct', 'sua_tong_pct', 'sua_ck_tinh', 'sua_ghichu', 'updated_by', 'created_at', 'updated_at', 'owner_user_id'],
    exportColumns: ['ngay', 'so_ct', 'dien_giai', 'ma_kh', 'ten_kh', 'ma_hang', 'ten_hang', 'sl_ban', 'don_gia', 'doanh_so', 'ck', 'sl_tra', 'gt_tra', 'gt_giam', 'thue', 'ck_pct_thuc_te', 'ck1_pct', 'ck2_pct', 'ck3_pct', 'tong_pct', 'ck_tinh', 'sai_so', 'nhom_mau', 'dieu_kien', 'giai_thich', 'sua_ck1_pct', 'sua_ck2_pct', 'sua_ck3_pct', 'sua_tong_pct', 'sua_ck_tinh', 'sua_ghichu', 'updated_by', 'id', 'created_at', 'updated_at', 'owner_user_id'],
    exportAllColumns: ['id', 'ngay', 'so_ct', 'dien_giai', 'ma_kh', 'ten_kh', 'ma_hang', 'ten_hang', 'sl_ban', 'don_gia', 'doanh_so', 'ck', 'sl_tra', 'gt_tra', 'gt_giam', 'thue', 'ck_pct_thuc_te', 'ck1_pct', 'ck2_pct', 'ck3_pct', 'tong_pct', 'ck_tinh', 'sai_so', 'nhom_mau', 'dieu_kien', 'giai_thich', 'sua_ck1_pct', 'sua_ck2_pct', 'sua_ck3_pct', 'sua_tong_pct', 'sua_ck_tinh', 'sua_ghichu', 'updated_by', 'created_at', 'updated_at', 'owner_user_id'],
    exportQuery: `SELECT t.*,
