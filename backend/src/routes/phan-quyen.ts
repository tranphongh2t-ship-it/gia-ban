...
const ALL_MENU_ITEMS = [
  ...
  { key: 'menu:/keo-nong', label: 'Keo nóng', group: '8 Nhóm Nhỏ' },
  { key: 'menu:/van-phu-acrylic', label: 'Ván phủ Acrylic', group: '8 Nhóm Nhỏ' },
  { key: 'menu:/van-phu-pvc', label: 'Ván phủ PVC', group: '8 Nhóm Nhỏ' },
  { key: 'menu:/nhua-phu-mau', label: 'Nhựa phủ màu', group: '8 Nhóm Nhỏ' },
  { key: 'menu:/nhua-laminate', label: 'Nhựa Laminate', group: '8 Nhóm Nhỏ' },
  { key: 'menu:/mirror', label: 'Mirror/Siêu bóng gương', group: '8 Nhóm Nhỏ' },
